...
public class DonateOrganActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.organ_donate_now);
    ...
    private static Spanned formatDonationInstructionDetails(Resources res,
        ...
        Log.e(TAG, res.getString(R.string.organ_donation_warning, bloodType));
        return Html.fromHtml(res.getString(R.string.organ_donation_warning, bloodType));
    }
                ...
                new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if (user == null) {
                            ...
                            Toast.makeText(DonateOrganActivity.this,
    ...
    private void writeNewDonation(final String postId, final String currentUId, final String postUId, final String placeId,
                                  final String donorBloodType, final String donorPhone, final String donorMessage) {

        mOrganPostsRef = mDatabase.child("organposts").child(postId);
        mOrganPostsRef.addListenerForSingleValueEvent(
                new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        // Get user value
                        OrganPost post = dataSnapshot.getValue(OrganPost.class);

                        // [START_EXCLUDE]
                        if (post != null) {
                            OrganDonor organDonor = new OrganDonor(post.title, donorBloodType,
                                    donorPhone,
                                    donorMessage);
                            Map<String, Object> postValues = organDonor.toMap();

                            Map<String, Object> childUpdates = new HashMap<>();
                            childUpdates.put("/organposts/" + postId + "/donorList/" + currentUId, postValues);
                            ...
                            childUpdates.put("/place-organposts/" + placeId + "/" + postId + "/donorList/" + currentUId,
                                    postValues);
                            childUpdates.put("/users/" + currentUId + "/organJourney/" + postId, postValues);
