...
public class SignedInActivity extends AppCompatActivity {
    private static final String TAG = "PHOTO_URI";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (currentUser == null) {
            startActivity(AuthUiActivity.createIntentBackToAuth(this));
            finish();
            return;
        }
        ...
        Log.d("emailverified", String.valueOf(emailVerified));
    }
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            startActivity(AuthUiActivity.createIntentBackToAuth(SignedInActivity.this));
                            finish();
                        } else {
    ...
    private void populateProfile() {
        ...
        mUserPhoneNumber.setText(
                TextUtils.isEmpty(user.getPhoneNumber()) ? "No recipientPhone number" : user.getPhoneNumber());
